            ...
            <form className="form" onSubmit={handleSubmit}>
                <div className="ship">
                    ...
                    <label className="field">
                        <span className="field__label" for="memberid">Member ID</span>
                        <input className="field__input" type="text" name="memberid" id="memberid" value={fontData.memberid} onChange={handleChange} required/>
                    </label>
